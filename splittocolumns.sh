...
#
# The pixel values were determined by using the `display` command and
# clicking with the middle mouse button. (Same pixel coordinate system
# as hOCR; with 0,0 in the top left of the page.)
declare -A mask
